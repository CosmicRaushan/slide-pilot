...
import { pitchDeckQualityCheckerGuardrail, validIdeaGuardrail } from "./guardrails";


const PITCH_DECK_INSTRUCTION = `You write startup pitch decks for       investors.

    Given a project idea, create 5–8 slides in this order:
...
export const pitchDeckAgent = new Agent({
    ...
    inputGuardrails: [validIdeaGuardrail],
    outputGuardrails: [pitchDeckQualityCheckerGuardrail]
})